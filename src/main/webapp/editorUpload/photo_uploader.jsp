...
<div id="pop_wrap">
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="#"><img src="/lib/editor/img/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="#"><img src="/lib/editor/img/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
<script type="text/javascript" src="/lib/editor/kossis/photo_uploader/jindo.min.js" charset="utf-8"></script>
<script type="text/javascript" src="/lib/editor/kossis/photo_uploader/jindo.fileuploader.js" charset="utf-8"></script>
<script type="text/javascript" src="/lib/editor/kossis/photo_uploader/attach_photo.js" charset="utf-8"></script>
